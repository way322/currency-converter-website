    ...
    <section class="section-Workspace ">
        <div class="contener-flex">
            <div class="conreiner2">
                <div class="contaner-reg">
                    <a href="index.php" class=""><img src="img/logo.svg" alt="" width="200px"></a>
                    <p>Регстрация</p>

                    <form class="register-flex" action="register.php" method="post">
                        <input class="registe" type="text" placeholder="login" name="login">
                        <input class="registe" type="text" placeholder="password" name="pass">
                        <input class="registe" type="text" placeholder="repeat password" name="repeatpass">
                        <input class="registe" type="text" placeholder="email" name="email">
                        <div class="registr-buton_footer">
                            <button class="registe-button" type="submit">зарегистрироватся</button>
                            <a class="alternative-registr" href="vhod.php">Войти</a>
                        </div>
                    </form>
